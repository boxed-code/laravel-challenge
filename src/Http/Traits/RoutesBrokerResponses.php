...
trait RoutesBrokerResponses
{
    ...
    protected function routeResponse($response, $method = null)
    {
        switch ($response) 
        {
            ...
            case AuthenticationBroker::CHALLENGE_VERIFIED:
            ...
            case AuthenticationBroker::CHALLENGE_NOT_VERIFIED:
            ...
            case AuthenticationBroker::CHALLENGE_NOT_FOUND:
