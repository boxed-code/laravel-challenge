...
Route::post('/tfa/challenge', 'Auth\TwoFactorAuthController@challenge')->name('tfa.challenge')->middleware('throttle:5,1');
Route::get('/tfa/{method}/verify', 'Auth\TwoFactorAuthController@showVerificationForm')->name('tfa.verify.form');
Route::post('/tfa/{method}/verify', 'Auth\TwoFactorAuthController@verify')->middleware('throttle:10,1');
Route::get('/tfa/{method}/enrol', 'Auth\TwoFactorAuthController@begin')->name('tfa.enrol')->middleware('throttle:10,1');
...
Route::post('/tfa/{method}/enrol/setup', 'Auth\TwoFactorAuthController@setup')->middleware('throttle:10,1');
